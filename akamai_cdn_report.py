...
def get_akamaicdn_status():
	endpoint_zones = '/config-dns/v2/zones?showAll=true&accountSwitchKey=1-14300z9'
	...
	for zone in zones['zones']:
		endpoint_type = '/config-dns/v2/zones/' + str(zone.get('zone')) + '/recordsets?types=AKAMAICDN&accountSwitchKey=1-14300z9'
